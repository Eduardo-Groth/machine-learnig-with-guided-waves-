...
MAIN GOAL: GENERATE OS SIGNALS TO TEST MACCHINBE LEARNING SCRIPTS TO APLIIED AT ACOUTIC SIGNALS 
"""
...
s.rectangle(point1=(-10e-3,-5e-3), point2=(1.2,10e-3))
c=0.5e-3
...
mdb.models['Model-1'].ExplicitDynamicsStep(name='Step-1', previous='Initial', timePeriod=0.001)
...
mdb.models['Model-1'].HistoryOutputRequest(name='monitormanento',createStepName='Step-1', variables=('U1', 'U2', 'U3', 'UR1', 'UR2','UR3'), frequency=1, region=regionDef, sectionPoints=DEFAULT,rebar=EXCLUDE)
...
#mdb.models['Model-1'].ConcentratedForce(name='Load-1', createStepName='Step-1', region=region, cf1=1e1, cf2=0, amplitude='Amp-1', distributionType=UNIFORM, field='', localCsys=None)

#prescribed motion 
mdb.models['Model-1'].DisplacementBC(name='BC-2', createStepName='Step-1', region=region, u1=1e-6, u2=-0, ur3=0, amplitude='Amp-1', fixed=OFF, distributionType=UNIFORM, fieldName='', localCsys=None)
a = mdb.models['Model-1'].rootAssembly
